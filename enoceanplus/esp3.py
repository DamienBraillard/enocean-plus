...
# CRC-8-CCIT polynomial table using polynomial G(x) = x^8 + x^2 + x^1 + x^0
# Extracted from the EnOcean serial protocol document "Appendix 3.3 (CRC calculation)"
#   at https://www.enocean.com/fileadmin/redaktion/pdf/tec_docs/EnOceanSerialProtocol3.pdf
# fmt: off
__CRC_TABLE = [
